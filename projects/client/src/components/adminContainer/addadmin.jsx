export default function AddAdmin() {
    return (
        <div className="h-full  px-10 py-5 font-semibold gap-4 ">
            <div className=" border shadow-xl h-full flex flex-col py-3 px-5">
                <div className="text-xl text-gray-500">
                    Admin information
                    <hr className="w-1/3 border border-b-gray-300" />
                </div>
                ...
                <div className="flex mt-5 flex-wrap gap-8 justify-center">
                    ...
                    <div class="relative w-1/3">
                        <input type="text" id="phone_number" class="block px-2.5 pb-2.5 pt-4 w-full text-sm text-gray-900 bg-transparent rounded-lg border-1 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
                        <label htmlFor="phone_number" class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-2 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-4 left-1">Phone_number</label>
                    </div>

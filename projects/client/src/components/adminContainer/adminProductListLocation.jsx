    ...
    let updateQty = async()=>{
        try {
            ...
            if(b<0){
                ...
                let data = await axios.post(`http://localhost:8000/location/stock`,{qty:onUpdateInc.current.value, status: "Additional", location_warehouse_id: loc, product_detail_id: proId, product_id: detailProId})
                console.log(data);
                setTimeout(() => {
                ...
                console.log(response);
                let data = await axios.post(`http://localhost:8000/location/stock`,{qty:onUpdateDec.current.value, status: "Reduction", location_warehouse_id: loc, product_detail_id: proId, product_id: detailProId})
                console.log(data);
                setTimeout(() => {
                    toast.success(`Update Quantity of Id ${quantity} Success`, {
                        duration: 3000
